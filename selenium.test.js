...
async function mockUserAction() { 
    ...
    // await driver.findElement(By.xpath('/html/body/app-root/main/app-profile-page/mat-sidenav-container/mat-sidenav-content/app-profile-header/mat-toolbar/a[2]/span')).click()
    // await driver.wait(until.urlIs('http://localhost:4200/editprofile'));

    
    // await driver.findElement(By.xpath('/html/body/app-root/main/app-edit-profile/mat-card/mat-horizontal-stepper/div[1]/mat-step-header[1]')).click()
    // await driver.findElement(By.xpath('/html/body/app-root/main/app-edit-profile/mat-card/mat-horizontal-stepper/div[1]/mat-step-header[2]')).click()
    // await driver.findElement(By.xpath('/html/body/app-root/main/app-edit-profile/mat-card/mat-horizontal-stepper/div[1]/mat-step-header[1]')).click()
    // await driver.findElement(By.xpath('/html/body/app-root/main/app-edit-profile/mat-card/mat-horizontal-stepper/div[2]/div[1]/form/div/button[2]')).click()

    // await driver.findElement(By.xpath('/html/body/app-root/main/app-edit-profile/mat-card/mat-horizontal-stepper/div[2]/div[1]/form/mat-form-field[8]/div/div[1]/div/textarea')).sendKeys(" I love my India")
    // await driver.findElement(By.xpath('/html/body/app-root/main/app-edit-profile/mat-card/mat-horizontal-stepper/div[2]/div[1]/form/div/button[1]')).click()
    // await driver.findElement(By.xpath('/html/body/app-root/app-header/mat-toolbar/a/span')).click()
    // await driver.wait(until.urlIs('http://localhost:4200/profile/myprofile'));
    // editedBio =await driver.findElement(By.xpath('/html/body/app-root/main/app-profile-page/mat-sidenav-container/mat-sidenav-content/app-profile/div[1]/p')).getAttribute('innerHTML');
    // await driver.findElement(By.xpath('/html/body/app-root/main/app-profile-page/mat-sidenav-container/mat-sidenav-content/app-profile-header/mat-toolbar/a[2]/span')).click()
    // await driver.wait(until.urlIs('http://localhost:4200/editprofile'));
    ...
    // await driver.findElement(By.xpath('/html/body/app-root/main/app-edit-profile/mat-card/mat-horizontal-stepper/div[2]/div[1]/form/mat-form-field[8]/div/div[1]/div/textarea')).clear()
    // await driver.findElement(By.xpath('/html/body/app-root/main/app-edit-profile/mat-card/mat-horizontal-stepper/div[2]/div[1]/form/mat-form-field[8]/div/div[1]/div/textarea')).sendKeys("Hey there!")
    // await driver.findElement(By.xpath('/html/body/app-root/main/app-edit-profile/mat-card/mat-horizontal-stepper/div[2]/div[1]/form/div/button[1]')).click()
    // await driver.findElement(By.xpath('/html/body/app-root/app-header/mat-toolbar/a/span')).click()
    // await driver.wait(until.urlIs('http://localhost:4200/profile/myprofile'));
...
async function mockUserAction2(){
    ...
    await driver.findElement(By.xpath('/html/body/app-root/app-header/mat-toolbar/a/span')).click()
    await driver.wait(until.urlIs('http://localhost:4200/profile/myprofile'));
    editedBio =await driver.findElement(By.xpath('/html/body/app-root/main/app-profile-page/mat-sidenav-container/mat-sidenav-content/app-profile/div[1]/p'));
...
it('check num of followers same as displayed',async()=>{
    ...
    expect(numfollowersdisp).toEqual("3");

})

it('click edit profile',async()=>{
    await mockUserAction2();
})

it('check edited Bio',async()=>{
    var bio;
    await editedBio.getAttribute('innerHTML').then(text => bio = text);
    expect(bio).not.toBeNull();
    expect(bio).toEqual(" Hey there! I love my India ");

})

it('click edit profi;le again',async()=>{
    await mockUserAction3();
})
